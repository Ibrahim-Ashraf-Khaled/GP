...
import { validateDateString, validateUUID } from '../utils/validation';
...
describe('Security Headers and CSP Tests', () => {
  it('should include all required security headers', () => {
    ...
    // Accept either src/middleware.ts or src/proxy.ts
    const candidates = [
  ...
  it('should have proper CSP configuration', () => {
    ...
    const middlewareContent = fs.readFileSync(file, 'utf8');
